                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-4">
                            <div className="single-widget">
                                ...
                                <ul>
                                    <li>
                                        <a target="_blank" href="https://wp.xn--petkarildefranceiftlii-f7b36k.com/wp-content/uploads/2022/07/CamScanner-06-27-2022-11.19.pdf">
                                        {footerContent[locale].tourismCertificate}
                                        </a>
                                    </li>

                                    <li>
                                        <a target="_blank" href="https://xn--petkarildefranceiftlii-f7b36k.com/wp-content/uploads/2022/07/CamScanner-07-04-2022-19.55.pdf">
